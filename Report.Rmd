...
Z_Score = function(data_value, sample_mean, sample_sd) {
    return(
        ( date_value - sample_mean ) / sample_sd
    )
}
...
fisher_transformed = Fisher_Transformation(0.56)

# Find upper and lower bounds
z_value = 1.96
log_upper_bound = Log_Bounds(TRUE, fisher_transformed, z_value, 30)

log_lower_bound = Log_Bounds(FALSE, fisher_transformed, z_value, 30)

# Find the confidence interval

CI_upper_val = CI_Upper(log_upper_bound)

CI_lower_val = CI_Lower(log_lower_bound)
