...
Let us examine what the data looks like.

```{r}
data = read.csv("./Data/3130 Final Project Data Sheet - Mean Atd Rate, Mean Daily Temp, & COVID-19.csv")
boxplot(data$mean_daily_atd_rate)
title(main = "Mean Daily Attendance Rate")
boxplot(data$temp_6am)
title(main = "Temperature 6am")
boxplot(data$temp_6pm)
title(main = "Temperature 6pm")
boxplot(data$mean_daily_temp)
title(main = "Mean Daily Temp")
```
