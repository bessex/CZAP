...
After the above averages were calcualted, a Fisher Transformation was performed on the data set pairs listed above to generate approximately normally distributed data to be used in calculating the correlation coefficnets for each of the associated pairs.
