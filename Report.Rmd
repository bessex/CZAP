...
CIUpper = function(pooled_sd, t_value, x_1, x_2, s_1, s_2) { # Entered t-value shoud be positive
    return(
        (x_1 - x_2) + t_value * pooled_sd * sqrt( (1 / s_1) + (1 / s_2) )
    )
}
...
CI_upper = CIUpper(atd_rate_vs_temp_pooled_sd,
                   atd_rate_vs_temp_t_value,
                   mean_daily_atd_rate_mean,
                   mean_daily_temp_mean,
                   mean_daily_atd_rate_sd,
                   mean_daily_temp_sd)
CI_lower = CILower(atd_rate_vs_temp_pooled_sd,
                   atd_rate_vs_temp_t_value,
                   mean_daily_atd_rate_mean,
                   mean_daily_temp_mean,
                   mean_daily_atd_rate_sd,
